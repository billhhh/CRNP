...
MR_folder_path = '/home/guest/Desktop/Gather/BraTS2020/MICCAI_BraTS2020_ValidationData'
img_folder_path = '/home/guest/Desktop/outputs'
save_path = '/home/guest/Desktop/outputs_posp'
...
for root, dirs, files in os.walk(img_folder_path):
    for i in sorted(files):
        ...
        mr_file = MR_folder_path + '/' + i[:-7] + '/' + i[:-7] + '_t1ce.nii.gz'
